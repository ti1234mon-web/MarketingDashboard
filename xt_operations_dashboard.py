...
# ============================================================
    ...
    community_kpis = [
        {"KPI": "Aktivitätsrate", "Berechnung": "(Aktive Mitglieder / Gesamtmitglieder) × 100", "Benchmark": "> 60 %", "Aktuell": "72 %", "Status": "🟢 Grün"},
        {"KPI": "Retention (Woche 1→2)", "Berechnung": "(Woche-2-aktiv / Woche-1-neu) × 100", "Benchmark": "> 70 %", "Aktuell": "78 %", "Status": "🟢 Grün"},
        {"KPI": "Retention (Monat 1→3)", "Berechnung": "(Monat-3-aktiv / Monat-1-neu) × 100", "Benchmark": "> 60 %", "Aktuell": "65 %", "Status": "🟢 Grün"},
        {"KPI": "Meeting-Teilnahme", "Berechnung": "(Teilnehmer / Mitglieder) × 100", "Benchmark": "> 40 %", "Aktuell": "52 %", "Status": "🟢 Grün"},
        {"KPI": "Tool-Nutzungsrate", "Berechnung": "(Mitglieder mit Tool-Eingabe / Gesamt) × 100", "Benchmark": "> 50 %", "Aktuell": "58 %", "Status": "🟢 Grün"},
        {"KPI": "Churn-Rate (monatlich)", "Berechnung": "(Kündigungen / Mitglieder) × 100", "Benchmark": "< 10 %", "Aktuell": "6 %", "Status": "🟢 Grün"},
    ]
    
    df_community = pd.DataFrame(community_kpis)
